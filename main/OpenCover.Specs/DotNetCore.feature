...
Scenario: Get coverage of a .net core 2.1 application using oldstyle
	Given I can find the OpenCover application
	And I can find the target .net core '2.1' application 'OpenCover.Simple.Target.Core.2.1'
...
Scenario: Get coverage of a .net core 2.1 application using oldstyle, with debugType = portable 
	Given I can find the OpenCover application
	And I can find the target .net core '2.1' application 'OpenCover.Simple.Target.Core.2.1.Portable'
	When I execute OpenCover against the target application using the switch '-oldstyle'
	Then I should have a results.xml file with a coverage greater than or equal to '100'%

Scenario: Get coverage of a .net core 2.1 application using oldstyle, with debugType = embedded 
	Given I can find the OpenCover application
	And I can find the target .net core '2.1' application 'OpenCover.Simple.Target.Core.2.1.Embedded'
	When I execute OpenCover against the target application using the switch '-oldstyle'
	Then I should have a results.xml file with a coverage greater than or equal to '100'%
